...
import com.dezhonger.token.IdToken;
import com.dezhonger.token.NumToken;
import com.dezhonger.token.StrToken;
    ...
    private void readLine() throws ParseException {
        ...
        while (pos < endPos) {
            ...
            if (matcher.lookingAt()) {
                ...
                throw new ParseException("bad com.dezhonger.token at line " + lineNo);
            }
        }
